    ...
    <body>
        <header style="display: flex; flex-direction: row;">
            <div class="logo">
                ...
                <h1 style="font-size: 35px !important;">Barberia B&L</h1>
            </div>
            <nav>
                <ul>
                    <li ><a href="#">Inicio</a></li>
                    <li ><a href="./Frame-login-general/Frame-login-generaal.jsp">Servicios</a></li>
                    <li ><a href="./Frame-login-general/Frame-login-generaal.jsp">Productos</a></li>
                    <li ><a href="./Frame-login-general/Frame-login-generaal.jsp">Sedes</a></li>
                    <li ><a href="./Frame-login-general/Frame-login-generaal.jsp">Reservas</a></li>
                    <li >
                </ul>
            </nav>
            <div style="display: flex; flex-direction: row;" class="user-icon">
                <a href="./Frame-login-general/Frame-login-generaal.jsp"><h5>Iniciar Sesión</h5></a>
